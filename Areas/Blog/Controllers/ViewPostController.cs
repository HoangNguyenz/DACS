...
namespace HocAspMVC4_Test.Areas.Blog.Controllers
{
    ...
    public class ViewPostController : Controller
    {
        ...
        //một yêu cầu HTTP được gửi đến đường dẫn "/post/abc.html" (trong đó "abc" là một giá trị bất kỳ),
        //phương thức Details sẽ được gọi để xử lý yêu cầu đó.
        ...
        public IActionResult Details(string postslug)
        {
            ...
            var postDetail = _context.Posts.Where(p => p.Slug == postslug)
                                        ...
                                        .ThenInclude(c => c.Author) //lấy author của comment
                                        .FirstOrDefault();
