...
//xây dụng các mục sidebar của AdminCP
namespace HocAspMVC4_Test.Menu
{
	...
	public class SidebarItem
	{
		...
		public string RenderHtml(IUrlHelper urlHelper)
		{
			...
			if (Type == SidebarItemType.Divider) //nếu là Divider thì
            {
				html.Append("<hr class=\"sidebar-divider\">");
			}
			else if (Type == SidebarItemType.Heading) //nếu là Divider thì
            {
				html.Append(@$"
            ...
            else if (Type == SidebarItemType.NavItem) //nếu là Navitem thì
            {
