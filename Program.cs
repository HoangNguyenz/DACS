...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        //đăng ký dịch vụ session CartService
        builder.Services.AddTransient<CartService>();

        //đăng kú dịch vụ IActionContextAccessor
        builder.Services.AddTransient<IActionContextAccessor, ActionContextAccessor>();

        //đăng kú dịch vụ AdminSidebarService
        ...
        //cấu hình authorization theo Policy (kiểm tra Role và cả Claim )
        builder.Services.AddAuthorization( options =>
        {
            options.AddPolicy("AllowEditRole", policyBuilder =>
            {
                ...
                policyBuilder.RequireClaim("Manage", "add", "update"); //claims có tên là Manage, và có giá trị là add or update
            });
